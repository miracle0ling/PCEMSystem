...
public class AchievementsWrapper extends BaseEntityWrapper<Achievements, AchievementsVO>  {
    ...
    public static AchievementsWrapper build() {
        return new AchievementsWrapper();
    }

	@Override
	public AchievementsVO entityVO(Achievements achievements) {
		AchievementsVO achievementsVO = BeanUtil.copy(achievements, AchievementsVO.class);
