...
public class ComprehensiveWrapper extends BaseEntityWrapper<Comprehensive, ComprehensiveVO>  {
    ...
    public static ComprehensiveWrapper build() {
        return new ComprehensiveWrapper();
    }

	@Override
	public ComprehensiveVO entityVO(Comprehensive comprehensive) {
		ComprehensiveVO comprehensiveVO = BeanUtil.copy(comprehensive, ComprehensiveVO.class);
